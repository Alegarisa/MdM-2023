...
ONCE THIS IS DONE, JOIN THE DATASETS AND CHECK THAT IDENTICAL IDS CORRESPOND TO THE SAME ROLE IN WAVE 1 AND WAVE 2
...
```{r}
test <- full_join(w1_scales_final, w2_scales_final, by = c("record_id", "condition")) %>%
    arrange(record_id)
```

duplicated case: id 1038
waiting to hear what to do. 

After this is resolved, export dataset and create a codebook. 
