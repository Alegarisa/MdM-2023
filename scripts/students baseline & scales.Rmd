...
var.test(sdq_ext ~ factor(demo002), data = student_scales) # variances are equal for externalizing
var.test(sdq_int ~ factor(demo002), data = student_scales) # variances are equal for internalizing
```
